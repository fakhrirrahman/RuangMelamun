                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form action="{{ route('kegiatan1.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Judul</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" name="judul" required>
                                    <div id="emailHelp" class="form-text">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleTextarea" class="form-label">Isi</label>
                                        <textarea class="form-control" id="exampleTextarea" name="isi" rows="3" required></textarea>
                                        <div id="emailHelp" class="form-text">
                                        </div>
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" name="foto" required>
                                    <div id="emailHelp" class="form-text">
                                    </div>
                                </div>
