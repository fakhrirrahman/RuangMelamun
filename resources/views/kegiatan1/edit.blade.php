                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Tambah Kegiatan 1</h6>
                            <form action="{{ route('kegiatan1.update',$kegiatan1 ->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Judul</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" name="judul" required value="{{ $kegiatan1 ->judul}}">
                                    <div id="emailHelp" class="form-text">
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <label for="exampleTextarea" class="form-label">isi</label>
                                    <textarea class="form-control" id="exampleTextarea" name="isi" rows="3" required>{{ $kegiatan1 ->isi}}</textarea>
                                    <div id="emailHelp" class="form-text">
                                    </div>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" name="tanggal"  value="{{ $kegiatan1 ->tanggal}}" required>
                                    <div id="emailHelp" class="form-text">
                                    </div>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <img src="{{ asset('foto_kegiatan1/' . $kegiatan1->foto) }}" alt="foto_kegiatan1" width="100" id="currentPhoto">
                                    </div>
                                    <input type="file" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="foto">
                                    <div id="emailHelp" class="form-text">
                                        Pilih file untuk mengganti foto yang ada.
                                    </div>
                                </div>
