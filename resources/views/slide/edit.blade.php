                            ...
                            <form action="{{ route('slide.update',$slide ->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" name="judul" required value="{{ $slide -> judul}}">
                                    <div id="emailHelp" class="form-text">
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <label for="exampleTextarea" class="form-label">Isi</label>
                                    <textarea class="form-control" id="exampleTextarea" name="isi" rows="3" required>{{ $slide -> isi}}</textarea>
                                    <div id="emailHelp" class="form-text">
                                    </div>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" name="link" required value="{{ $slide -> link}}">
                                    <div id="emailHelp" class="form-text">
                                    </div>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <img src="{{ asset('foto_slide/' . $slide->foto) }}" alt="foto_slide" width="100" id="currentPhoto">
                                    </div>
