                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <a href="{{route('buku.create')}}" type="button" class="btn btn-primary m-2">Tambah Produk</a>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $book->harga }}</td>
                                            <td>{{ $book->link }}</td>
                                            <td><img src="{{ asset('foto_buku/' . $book->foto) }}" alt="foto_buku" width="100"></td>

                                           <td><a href="{{route('buku.edit', $book->id)}}" type="button" class="btn btn-primary">Edit</a> </td>
                                           <td>
                                                  <form action="{{ route('buku.destroy', $book->id) }}" method="POST" type="button" class="btn btn-danger p-0" onsubmit="return confirm('Delete?')">
                                                      @csrf
                                                      @method('DELETE')
