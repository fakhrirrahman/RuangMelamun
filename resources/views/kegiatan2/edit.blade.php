                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Edit Kegiatan 2</h6>
                            <form action="{{ route('kegiatan2.update',$kegiatan2 ->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Isi</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" name="isi" required value="{{ $kegiatan2 ->isi}}" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <img src="{{ asset('foto_kegiatan2/' . $kegiatan2->foto) }}" alt="foto_kegiatan2" width="100" id="currentPhoto">
                                    </div>
